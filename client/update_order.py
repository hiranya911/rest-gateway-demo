...
if __name__ == '__main__':
    parser = OptionParser()
    parser.add_option('-o', '--order', dest='order', help='ID of the order to update')
    ...
    if not options.order:
        report_error('Please specify the ID of the order to update')
    order = options.order
    ...
    conn.request('PUT', '/order/' + order, payload, headers)
